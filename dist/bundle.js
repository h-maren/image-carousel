...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://template/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _chgImage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chgImage.js */ \"./src/chgImage.js\");\n\n\n\nconst prevBtn = document.querySelector(\".prev-btn\");\nconst nextBtn = document.querySelector(\".next-btn\");\nconst imageNav = document.querySelector(\".img-nav-dots\");\nconst imageNavDots = imageNav.querySelectorAll(\"svg\");\n\nprevBtn.addEventListener(\"click\",_chgImage_js__WEBPACK_IMPORTED_MODULE_1__.showPrevImage);\nnextBtn.addEventListener(\"click\",_chgImage_js__WEBPACK_IMPORTED_MODULE_1__.showNextImage);\n\n//creating index attribute for image dots\nimageNavDots.forEach((dot,index) => {\n    dot.addEventListener(\"click\",_chgImage_js__WEBPACK_IMPORTED_MODULE_1__.selectImage);\n    dot.classList.add(`index-${index}`);\n    dot.setAttribute('data-index',index);\n});\n\nsetInterval(_chgImage_js__WEBPACK_IMPORTED_MODULE_1__.showNextImage,5000);\n\n//# sourceURL=webpack://template/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"55f6caccde2b722653ef.svg\";\n\n//# sourceURL=webpack://template/./src/menu-left.svg?");
...
eval("module.exports = __webpack_require__.p + \"d2142e58b74b8b74ef50.svg\";\n\n//# sourceURL=webpack://template/./src/menu-right.svg?");
